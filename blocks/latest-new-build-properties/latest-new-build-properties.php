<?php
/**
 * Block template for Latest New Build Properties
 */

$block_classes = get_block_classes('latest-new-build-properties');

// Get the office post by title
$office = get_page_by_title('Land and New Homes', OBJECT, 'office');

$office_id = $office ? $office->ID : 0;
...
// Only add office filter if office exists
if ($office_id) {
	$q_args['meta_query'][] = [
		'key'     => '_office_id',
		'value'   => $office_id,
...
<section class="block latest-new-build-properties <?php echo esc_attr($block_classes); ?>">
	<svg class="ribbon" viewBox="0 0 1920 315" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<defs>
			<linearGradient id="ribbonGradient-buy" x1="-8" y1="203" x2="2059" y2="203" gradientUnits="userSpaceOnUse"
				...
				<stop stop-color="#FCBBCA" />
				<stop offset="0.538462" stop-color="#FF2E69" />
				<stop offset="1" stop-color="#FCBBCA" />
			</linearGradient>
		</defs>
	</svg>
	<div class="wrap">
