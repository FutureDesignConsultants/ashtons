<?php
/**
* Block template for mortgageable Team members
*/

$block_classes = get_block_classes('mortgage-team-members');

$team_members = get_field('team_members');

?>

<section class="block mortgage-team-members <?php echo esc_attr($block_classes); ?>">
	<div class="wrap">
		<h2>Meet the MortGAGEABLE TEAM</h2>
		...
		<div class="team-members-container">
			...
			<div class="team-member-container" id="team-member-container">
				<div class="hover-div-container" id="hover-div-container">
					...
					<div class="flex w-full align-center lg:flex-row flex-col gap-16 lg:gap-16 contact-div">
						<?php if ($email): ?>
		...
		<button type="button" class="cta-button square blue view-more">
			<span>View more</span>
		</button>
	</div>
</section>
...
document.addEventListener('DOMContentLoaded', function() {
	...
	const updateVisibleItems = () => {
		...
		if (viewMoreBtn) {
			if (teamMembers.length <= initialVisibleCount || visibleCount >= teamMembers.length) {
